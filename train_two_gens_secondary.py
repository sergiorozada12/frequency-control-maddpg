...
with tf.Session() as sess:
    ...
    for i in range(episodes):
        ...
        #################
        area.set_load(3.5 + (- 0.25 + np.random.rand() / 2))
        #################
        ...
        for j in range(steps):
            ...
            print("Delta f: {:+04.2f}  Z1: {:05.2f}  Z2: {:05.2f}  Reward: {:04f}  Epsilon: {:05.4f}  a1: {:+04.2f}  \
a2: {:+04.2f}   Q1: {:+05.1f}  Q2: {:+05.1f}"
    ...
    saver.save(sess, "model/model_two_gens_wiener")
    with open("rewards/two_gens_wiener.pickle", "wb") as handle:
